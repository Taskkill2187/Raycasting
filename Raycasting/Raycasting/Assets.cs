...
namespace Raycasting
{
    public static class Assets
    {
        ...
        public static Effect LightSource2DShader;
        ...
        public static void Load(ContentManager Content, GraphicsDevice GD)
        {
            ...
            LightSource2DShader = Content.Load<Effect>("LightSource2DShader");
            LightSource2DShader.Parameters["TexX"].SetValue(Values.WindowSize.X);
            LightSource2DShader.Parameters["TexY"].SetValue(Values.WindowSize.Y);
            Blur = Content.Load<Effect>("SimpleBlur");
        }
